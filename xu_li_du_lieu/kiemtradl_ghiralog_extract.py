...
CSV_PATH = r"F:\Documents\CODE\Python\cv_project\stock\HQTCSDL_stocks\data\dirty\Data_500_stocks_dirty.csv"
OUTPUT_DIR = Path(
	r"F:\Documents\CODE\Python\cv_project\stock\HQTCSDL_stocks\data\khaosatdata"
)
