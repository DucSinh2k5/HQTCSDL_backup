...
MODEL3_ROOT = Path(__file__).resolve().parents[1]
...
DATA_SOURCE = os.getenv("MODEL3_DATA_SOURCE", "clickhouse").strip().lower()
...
MODEL_DIR = MODEL3_ROOT / "models"
REPORTS_DIR = MODEL3_ROOT / "reports"

MODEL_PATH = MODEL_DIR / "trading_signal_xgb_classifier.pkl"

METRICS_PATH = REPORTS_DIR / "metrics.json"
PREDICTION_PATH = REPORTS_DIR / "predictions.csv"
PREDICTION_ACCURACY_PATH = REPORTS_DIR / "prediction_accuracy.csv"
...
WALK_FORWARD_PREDICTION_PATH = REPORTS_DIR / "walk_forward_predictions.csv"
WALK_FORWARD_FOLD_METRICS_PATH = REPORTS_DIR / "walk_forward_fold_metrics.csv"
WALK_FORWARD_BACKTEST_PATH = REPORTS_DIR / "walk_forward_backtest.csv"
WALK_FORWARD_BACKTEST_METRICS_PATH = REPORTS_DIR / "walk_forward_backtest_metrics.json"
