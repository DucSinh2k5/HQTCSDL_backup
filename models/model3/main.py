...
from src.config import (
    ...
    BACKTEST_MIN_BUY_PROBABILITY_VALUES,
...
def main():
    ...
    y_train = train_df["target_signal_label"]

    X_val = validation_df[final_features]
    y_val = validation_df["target_signal_label"]
    ...
    backtest_sweep_df = run_backtest_sweep(
        ...
        min_buy_probability_values=BACKTEST_MIN_BUY_PROBABILITY_VALUES,
        transaction_cost_rate=TRANSACTION_COST_RATE,
        slippage_rate=SLIPPAGE_RATE
    )
